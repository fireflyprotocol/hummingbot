...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://auth.api.prod.kora.so" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("kora_auth_client")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        return [
            {
                'url': "https://auth.api.prod.kora.so",
                'description': "Production",
            },
            {
                'url': "https://auth.api.staging.kora.so",
                'description': "Staging",
            },
            {
                'url': "https://auth.api.dev.kora.so",
                'description': "Dev",
            }
        ]
