...
from kora_auth_client.configuration import Configuration
from kora_auth_client.api_response import ApiResponse, T as ApiResponseT
import kora_auth_client.models
from kora_auth_client import rest
from kora_auth_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(kora_auth_client.models, klass)
